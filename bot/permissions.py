...
class PermissionChecker:
    ...
    def require_level(self, message: Message, required_level: int) -> bool:
        ...
        if required_level == PermissionLevel.MODERATOR:
            raise PermissionDeniedError("🕯️ Solo los guardianes y el invocador pueden usar este eco")
        elif required_level == PermissionLevel.OWNER:
            raise PermissionDeniedError("🕯️ Solo el invocador del relicario puede usar este eco")
        elif required_level == PermissionLevel.VIP:
            raise PermissionDeniedError("🕯️ Solo los elegidos (VIP, guardianes o el invocador) pueden usar este eco")

        raise PermissionDeniedError("🕯️ No tienes permiso para usar este eco")
